              ...
              return (
                <tr key={record.id} className="hover:bg-slate-50/80 transition-colors group">
                  ...
                  <td className="px-8 py-6 align-top">
                    {result ? (
                      <div className="space-y-3">
                        <div className={`inline-flex items-center px-2.5 py-1 rounded-full text-xs font-bold border ${result.evidence_analysis?.strength?.includes('强') ? 'bg-emerald-50 text-emerald-700 border-emerald-100' :
                        ...
                        <div className="pt-2 border-t border-slate-100 mt-2">
                          <span className="text-[10px] text-slate-400 uppercase tracking-wide">关键词</span>
